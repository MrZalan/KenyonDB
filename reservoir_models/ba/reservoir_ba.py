...
class MergedModel(nn.Module):
    def __init__(
        ...
        self.reservoir = ReservoirLayer(
            ...
            input_size=0,
            topology=("barabasi_albert", {"m": res_config.ba_m, "seed": res_config.ba_seed}),
...
def main():
    ...
    torch.save(
        ...
        "checkpoints/reservoir_ba_mnist.pt",
    )
    print("Saved: checkpoints/reservoir_ba_mnist.pt")
