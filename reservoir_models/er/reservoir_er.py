...
class MergedModel(nn.Module):
    def __init__(
        ...
        self.reservoir = ReservoirLayer(
            ...
            input_size=0,
            topology=("erdos_renyi", {"p": res_config.er_p, "seed": res_config.er_seed}),
...
def main():
    ...
    torch.save(
        ...
        "checkpoints/reservoir_er_mnist.pt",
    )
    print("Saved: checkpoints/reservoir_er_mnist.pt")
